...
import { BookOpen, Mail, Lock, RefreshCw } from 'lucide-react';
...
export default function ResetPassword({ token, email }: { token: string; email: string }) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden">
            <Head title="Reset Kata Sandi - AksaraNet" />
            ...
            <div className="w-full max-w-md relative z-10 space-y-6">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-xs text-slate-400">Buat kata sandi baru untuk akun Anda</p>
                </div>
                ...
                <div className="bg-[#111622] rounded-3xl p-6 sm:p-8 border border-slate-800/80 shadow-2xl space-y-5">
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        >
                            <RefreshCw className="w-4 h-4" /> Reset Kata Sandi
                        </button>
                    </form>
                </div>
            </div>
